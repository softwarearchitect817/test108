    ...
    <div class="progress">
        <div class="container">
            ...
            <p class="progress__text">
                When playing slots, you’ll accumulate points and guarantee yourself increasingly larger rewards for opening
                new statuses. These rewards are an addition to your in-game wins. To see all the rewards available, check
                out the table below. Here we go!
            </p>
                    ...
                    @foreach ($progress as $item)
                        <div class="progress__item @if (auth()->user()->rating == $item->rating) active @endif">
                            <div class="progress__icon">
                                ...
                                <img src="/public/frontend/Default/img/badges128x128/badge-{{ $badge }}.png"
                                    alt="">
                            </div>
                            <div class="progress__top">
                                <span class="progress__label level">{{ $item->rating }} level</span>
                                <span class="progress__label cr">{{ number_format($item->bonus, 0, '', ' ') }}
                                    {{ $currency }}</span>
                            </div>
