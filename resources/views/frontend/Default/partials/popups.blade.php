    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-base ng-scope">
                ...
                <h3 class="modal-base__title ng-scope" translate="frontend.links.login">Sign In with your account</h3>
                <form ng-submit="sendForm($event)" action="<?= route('frontend.auth.login.post') ?>" method="POST"
                    data-modal-success="#login-modal" style="margin: 1.2rem">
                    @csrf
                    <div class="form">
                    ...
                    <div class="modal-base__btn-wrp">
                        ...
                        <button class="modal-base__login_button form__btn form__btn--mrg-btm ng-binding"
                    ...
                    <div class="modal-base__create-account">
                        Don't you have account?
                        <span class="modal-base__create-account-link">Create now!</span>
                    </div>
                </form>
            </div>
        </div>
