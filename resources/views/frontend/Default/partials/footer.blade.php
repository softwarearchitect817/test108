                ...
                <div class="footer__item-acc">
                    <div class="footer__item-acc-img">
                        <a href="javascript:;" data-name="modal-info" class="modal-btn">
                            <!-- <img src="/public/frontend/Default/img/badges64x64/badge-{{ auth()->user()->badge() }}.png" class="rating" > -->
                            <img src="/public/back/img/1.png" class="rating">
                        </a>
                    ...
                    <ul class="footer__item-acc-info">
                        ...
                        @if (isset($refund) &&
                            ...
                            <li class="refunds-icon"><span class="info-name">Refunds:</span> <span
                                    class="info-value count_refund"
                ...
                <div class="footer__item-tabs">
                    {{-- <a href="{{route('frontend.pincode.list')}}" class="footer__item-tab">
                        <div class="footer__item-tab-img">
                            <img src="/public/frontend/Default/img/svg/kassa.svg" alt="">
                        </div>
                    ...
                    <a href="javascript:;"
                        @if (auth()->user()->phone_verified) @if (auth()->user()->agreed)
                                data-name="modal-invite-1"
                           @else(!auth()->user()->agreed)
                                data-name="modal-invite" @endif
                    @else data-name="modal-invite-3" @endif
                        class="footer__item-tab modal-btn">
                        <div class="footer__item-tab-img">
                            <img src="/public/frontend/Default/img/svg/sms.svg" alt="">
                        </div>
                    ...
                    <a href="javascript:;" data-name="modal-loot" class="footer__item-tab modal-btn">
                        <div class="footer__item-tab-img">
                            <img src="/public/frontend/Default/img/svg/coleso.svg" alt="">
                        </div>
                    ...
                    <a href="javascript:;" data-name="modal-bonus" class="footer__item-tab modal-btn">
                        <div class="footer__item-tab-img">
                            <img src="/public/frontend/Default/img/_src/lootbox.png" alt="">
                        </div>
    ...
    <div class="modal__body">
        <div class="modal__content">
                ...
                <div class="modal__table-wrap" data-simplebar2 id="myEl">
                    <div class="footer__item-acc">
                        ...
                        <button type="submit" class="btn btn-sm btn-primary"
                            style="padding: 0px;line-height: 0px;height: 40px;width: 78px;">Buy Pins</button>
                    </div>
                    <br>
                    <hr><br>
                    <div class="box-body box-profile">
                        ...
                        <div class="modal__kassa-row">
                            ...
                            <input type="text" class="form-control" disabled readonly
                                placeholder="(@lang('app.optional'))" value="{{ auth()->user()->username }}">
                        </div><br>
                        ...
                        @if (auth()->user()->email != '')
                            <div class="modal__kassa-row">
                                ...
                                <input type="email" class="form-control" disabled readonly
                                    placeholder="(@lang('app.optional'))" value="{{ auth()->user()->email }}">
                            </div> <br>
                        @endif
                        ...
                        <div class="modal__kassa-row">
                            ...
                            <input type="password" class="form-control" id="old_password" name="old_password"
                                placeholder="@lang('app.leave_blank_if_you_dont_want_to_change')" autocomplete="off" autosuggestion="off">
                        </div> <br>

                        <div class="modal__kassa-row">
                            <label>{{ trans('app.new_password') }}</label>
                            <input type="password" class="form-control" id="password" name="password"
                                placeholder="@lang('app.leave_blank_if_you_dont_want_to_change')" autocomplete="off">
                        </div> <br>

                        <div class="modal__kassa-row">
                            <label>{{ trans('app.confirm_new_password') }}</label>
                            <input type="password" class="form-control" id="password_confirmation"
                                name="password_confirmation" placeholder="@lang('app.leave_blank_if_you_dont_want_to_change')" autocomplete="off">
                        </div>
                    </div>
                    <div>
            ...
            <span class="close-btn">
                <img src="/public/frontend/Default/img/_src/close.svg" alt="">
            </span>
        </div>
    </div>
</div>
                        ...
                        <div class="modal__slider-item">
                            <div class="modal__slider-row">
                                <div class="modal__slider-img">
                                    <img src="/public/frontend/Default/img/badges64x64/badge-01.png" alt="">
            ...
            <div class="modal__kassa">
                ...
                <div class="modal__kassa-row">
                            ...
                            @foreach ($interkassa['systems'] as $system)
                                ...
                                <div class="modal__kassa-row-item">
                                    <div class="modal__kassa-row-img">
                                        <img src="/public/frontend/Default/img/_src/logo-{{ $system['ps'] }}.png"
                                            alt="">
                                    </div>
                    ...
                    @if (setting('payment_coinbase') &&
                        ...
                        <div class="modal__kassa-row-item">
                            <div class="modal__kassa-row-img">
                                <img src="/public/frontend/Default/img/_src/logo-kassa-2.png" alt="">
                            </div>
                            <div class="modal__kassa-row-input">
                                <input type="text" placeholder="Enter the amount" name="summ">
                            </div>
                        ...
                        {!! Form::close() !!}
                    @endif
                    @if (setting('payment_btcpayserver') &&
                            !(
                        ...
                        <div class="modal__kassa-row-item">
                            <div class="modal__kassa-row-img">
                                <img src="/public/frontend/Default/img/_src/logo-kassa-3.png" alt="">
                            </div>
                            <div class="modal__kassa-row-input">
                                <input type="text" placeholder="Enter the amount" name="summ">
                            </div>
                    ...
                    @if (setting('payment_pin'))
                        <div class="modal__kassa-row-item">
                            <div class="modal__kassa-row-img">
                                <img src="/public/frontend/Default/img/_src/logo-kassa-4.png" alt="">
                            </div>
                            <div class="modal__kassa-row-input">
        ...
        <div class="modal__content">
            <div class="modal__invite">
                ...
                <p class="modal__text">
                    ...
                    the {{ config('app.name') }} community. Every referral earns you
                    ${{ isset($invite) && $invite->sum }} in Bonus Rewards!
                    Plus, every person you invite gets a free ${{ isset($invite) && $invite->sum_ref }} Bonus when they
                    use purchase code for first-time deposit of ${{ isset($invite) && $invite->min_amount }}!
                    <br>
                    <br>
                        ...
                        <tbody>
                            ...
                            @if ($progress)
                                @foreach ($progress as $item)
                                    <tr>
                                        <td class="big-td"><img
                                                src="/public/frontend/Default/img/badges64x64/badge-{{ $item->badge() }}.png"
                                                alt="">Range #{{ $item->rating }}</td>
                                        <td>{{ $item->sum }}</td>
                                        <td>
                                            @if ($item->type == 'sum_pay')
                                                Pay Sum
                                            @else
                                                One Pay
                                            @endif
                                    ...
                                    <div class="modal__invite-row" id="reward{{ $reward->id }}">
                                        <div class="modal__invite-info">
                                            <div class="modal__invite-date">
                                                {{ $reward->created_at->format(config('app.date_format')) }}</div>
                                        ...
                                        @if ($reward->activated)
                                            <div class="modal__invite-phones-btn">
                                                <a href="javascript:;" class="btn take_reward"
                                                    data-id="{{ $reward->id }}">Take bonus</a>
                                            </div>
                                        @endif
                                    </div>
                                @endif
                ...
                <div class="modal__invite-item">
                    ...
                    <div class="modal__invite-pin">
                        <form name='PINform' class="form-pin">
                            ...
                            <input type='button' class='buttonClear clear' value='C'
                                onClick=clearForm(this); />
                            <input type='button' class='PINbutton' name='0' value='0' />
                            <input type='button' class='buttonClear backspace' value='X'
                                onClick=backspace(this); />
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="modal__content">
            ...
            <div class="modal__invite-block">
                ...
                <div class="modal__invite-item">
                    ...
                    <div class="modal__invite-input">
                        <input type="text" class="loginInput bonus-input" placeholder="X  X  X  X"
                            autocomplete='off' id="myCode">
                        <span class="error-message"></span>
                    </div>
                    <div class="modal__invite-pin">
                        <form name='PINform' class="form-pin">
...
<div class="popup popup-1">
    <div class="popup__body">
        <div class="popup__content" style="background-image: url('/public/frontend/Default/img/_src/popup-bg-1.png')">
...
<div class="popup popup-2">
    <div class="popup__body">
        <div class="popup__content">
            <div class="popup__bg" style="background-image: url('/public/frontend/Default/img/_src/popup-bg-2.png')">
            </div>
            <div class="popup__value">
                <img src="/public/frontend/Default/img/badges320x320/badge-15.png" alt="">
            </div>
            <div class="popup__info">
                <div class="popup__title">
                    Congratulations!
