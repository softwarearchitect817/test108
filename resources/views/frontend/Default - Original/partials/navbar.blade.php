...
<section id="woocasino" class="carcass">
    ...
    <div class="top-bar">
        ...
        <div style="display: flex;width: calc(100% - 350px);">
            <div style="width: 20%;"><input type="text" class="search" placeholder="Find your Game"
                    style="border-radius: 15px;width: 100%;background: #00030a;padding: 2px 15px;border-style: solid;">
            </div>
		...
		filter:drop-shadow(0 0 5px orange);
                            ...
                            border: 1px dashed orange;">
                                    ...
                                    <div class="jackpot jackpot--value s">JACKPOT $
                                        {{ number_format($jpg->balance, 2, '.', '') }}</div>
                                </div>
                            </div>
                        @endif
                    @endforeach
            ...
            <div class="alert_1"> Check template update <a href="https://t.me/goldsvetworkshop"> Goldsvetworkshop </a>
            </div>
        </div>
        <!-- jackpot -->
        ...
        <div class="top-bar__content">
            @if (!isset(auth()->user()->username))
                <div class="top-bar__anon ng-scope" ng-if="!$root.data.user.email">
                    <button class="top-bar__sign-up button button-primary button-small ng-scope"
                        ...
                        <li class="locale-selector__item" style="margin: 4px 6px;">
                            <i data-lang-code="{{ $k }}" role="button">
                                <img class="locale-selector__img" alt="{{ $v }}"
                                    ...
                                    class="locale-selector__dropdown-name ng-binding">{{ strtoupper(substr($v, 0, 3)) }}</span>
                            </i>
                        </li>
                    @endforeach
                </ul>
                        ...
                        @if ($categories && count($categories))
                            @foreach ($categories as $index => $category)
                                <li class="providers-mob__item ng-scope">
                                    <a class="providers-mob__link providers-mob__link--exclusive" scroll-up=""
                                        href="{{ route('frontend.game.list.category', $category->href) }}">
                                        <span class="providers-mob__icon-wrp">
                                            <span class="providers-mob__icon">
                                                <img class="providers-mob__icon-img providers-mob__icon-img--pragmaticplay"
                                                    src="/public/woocasino/logos/{{ $category->href }}.svg">
                                            </span>
                    ...
                    @if ($categories && count($categories))
                        @foreach ($categories as $index => $category)
                            <li class="games-menu-mob__item games-menu-mob__item--woo_choice">
                                <a class="games-menu-mob__link games-menu-mob__link--woo_choice" scroll-up=""
                                    href="{{ route('frontend.game.list.category', $category->href) }}"> <i
                                        class="games-menu-mob__icon icon-woo-menu-default icon-woo-woo_choice"></i>
                                    <span class="games-menu-mob__title ng-scope">{{ $category->title }}</span> </a>
                            </li>
                        @endforeach
                    @endif
                </ul>
