...
<header class="header">
    ...
    <div class="header__container">
        <div class="header__logo">
            <video style=" border-radius:15px 50px;border-color:#484347" width="200" height="112" muted autoplay
                loop>
                <source src="/public/frontend/Default/casinosweeps.mp4" type="video/mp4">
        ...
        <div class="header__container-bg">
            <div class="header-auth ng-isolate-scope">
                <div class="header-auth__anon ng-scope">
                    <div class="header-auth__anon-status"> <img class="header-auth__anon-img"
                            src="/public/woocasino/resources/images/status/anon.svg" alt=""> </div>
