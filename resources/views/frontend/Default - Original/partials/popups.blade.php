        ...
        <div class="modal-content">
            <div class="modal-base ng-scope">
                ...
                <div class="modal-base__header-decor">
                    <img class="modal-base__decor-logo" src="/public/woocasino/resources/images/logo1.png"
                        alt="">
                </div>
                <h3 class="modal-base__title ng-scope" translate="frontend.links.login">@lang('app.log_in')</h3>
                <div>
                    <a style="color: black; font-size: 20px; display: flex; align-items: center; justify-content: center; cursor: pointer; "
                        href="{{ route('frontend.auth.google.login') }}">
                        <img src="/public/frontend/Default/img/google.png" style="height: 35px;">
                        &nbsp;&nbsp;&nbsp;Login with Google
                    </a>
                </div>
                    ...
                    <div class="form">
                        <div class="form__field">
                            ...
                            <input type="text" name="username"
                                class="input-elem ng-pristine ng-valid ng-empty ng-valid-username ng-touched"
                                id="username" placeholder="@lang('app.username')">
                        </div>
                        <div class="form__field">
                            <div class="input-elem__label ng-binding">@lang('app.password')</div>
                            <input type="password" class="input-elem ng-pristine ng-valid ng-empty ng-touched"
                                name="password" id="password" placeholder="@lang('app.password')">
                        </div>
                    </div>
                    <div class="modal__error" style="display: none"></div>
                    <div class="modal-base__forgot-password">
                        @if (settings('forgot_password') || true)
                            <a class="modal-base__link ng-scope" href="javascript:;"
                                ng-click="openModal($event, '#restore-password')">@lang('app.forgot_your_password')</a>
                        @endif
                    </div>
                    <div class="modal-base__btn-wrp">
                        <input type="hidden" value="/" name="is_ajax" id="is_ajax" />
                        <button class="button button-secondary form__btn form__btn--mrg-btm ng-binding" type="submit"
                            style="width:90%;">@lang('app.login')</button>
                        <button class="button button-neutral form__btn ng-scope ng-binding"
                            ng-click="openModal($event, '#registration-confirm')"
                            style="width:90%;">@lang('app.register')</button>
                    </div>
                </form>
            </div>
        </div>
...
@if (settings('reg_enabled') || true)
    <div id="registration-confirm" tabindex="-1" role="dialog" class="modal modal-registration"
        ng-click="close($event)" modal-window="" window-class="modal-registration" style="background:transparent;">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <div class="registry-modal__wrap">
                        <div class="registry-modal__content">
                            <div class="registry-modal__content-txt">
                                <div class="registry-modal__mobile-nav">
                                    ...
                                    <span class="registry-modal__mobile-close icon-woo-close-bold"
                                        data-dismiss="modal" ng-click="$close();"></span>
                                </div>
                                <div class="ng-binding ng-scope ng-isolate-scope">
                                    <h2 class="registry-modal__content-title registry-modal__content-title--desktop">
                                        ...
                                        <span class="registry-modal__content-rows-wrp">
                                            <span
                                                class="registry-modal__content-title-big text-color-yellow">$/€200</span>
                                            <span class="registry-modal__content-title-small ">+ 200 Free Spins</span>
                                        </span>
                                    </h2>
                                    <h2
                                        class="registry-modal__content-title registry-modal__content-title registry-modal__content-title--mob">
                                        <span class="registry-modal__content-title-small">Welcome Bonus</span>
                                        <span class="registry-modal__content-rows-wrp">
                                            <span
                                                class="registry-modal__content-title-big text-color-yellow">$/€200</span>
                                            <span
                                                class="registry-modal__content-title-small registry-modal__content-title-small--mob-decor">+
                                                200 FS</span>
                                        </span>
                                    </h2>
                                </div>
                        ...
                        <div class="registry-modal__form-wrp">
                            ...
                            <form method="post" action="<?= route('frontend.register.post') ?>"
                                ng-submit="sendForm($event)" data-modal-success="#system-notification-success"
                                class="registry-modal__form form form--reg ng-pristine ng-valid ng-isolate-scope">
                                @csrf
                                <input type="hidden" value="/" name="is_ajax" id="is_ajax" />
                                <div>
                                    <div class="form__step form__step--1">
                                        <div class="form__field form__field--username">
                                            ...
                                            <input type="text" id="username" name="username"
                                                ...
                                                class="input-elem ng-pristine ng-valid ng-empty ng-touched">
                                        </div>
                                        ...
                                        <div class="form__field form__field--password">
                                            ...
                                            <input placeholder="@lang('app.password')" type="password" name="password"
                                                class="input-elem ng-pristine ng-untouched ng-valid ng-isolate-scope ng-empty ng-valid-password-strength"
                                                autocomplete="off">
                                        </div>
                                        <div class="form__field form__field--confirm_password">
                                            <span class="input-elem__label ng-scope">@lang('app.confirm_password')</span>
                                            <input placeholder="@lang('app.confirm_password')" type="password"
                                                id="password_confirmation" name="password_confirmation"
                                                class="input-elem ng-pristine ng-untouched ng-valid ng-isolate-scope ng-empty ng-valid-confirm_password-strength"
                                                autocomplete="off">
                                        </div>
                                        <div
                                            class="form__field form__field--age_terms_acceptance form__field--checkbox">
                                            <label class="checkbox-elem">
                                                <input
                                                    class="checkbox-elem__input ng-pristine ng-untouched ng-valid ng-empty"
                                                    type="checkbox" placeholder="">
                                                <span class="checkbox-elem__icon icon-woo"></span>
                                                <span class="checkbox-elem__text">
                                                    <span class="ng-binding">
                                                        I am over 18 years old and I have read and accept the terms and
                                                        conditions.
                                ...
                                <div class="form__btn-wrp">
                                    <input class="button button-primary ng-scope" type="submit"
                                        value="@lang('app.register')">
                                </div>
                                <div class="registry-modal__form-descr">
                                    <span class="ng-binding">@lang('app.already_have_an_account')</span>
                                    <a class="registry-modal__form-descr-link ng-scope ng-binding"
                                        ng-click="openModal($event, '#login-modal')">@lang('app.log_in')</a>
                                </div>
                                <div class="modal__error" style="display: none"></div>
                            </form>
                        </div>
