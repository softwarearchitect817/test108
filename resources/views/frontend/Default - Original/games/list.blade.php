    ...
    <main class="carcass__body">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="item text-center ng-scope ng-isolate-scope active">
                                        <div class="mobile-slider__img ng-scope"
                                            style="background-image: url(/public/woocasino/images/bg/472/original/gennie-bg.jpg)">
                                        </div>
                                    </div>
                                    <!-- end ngRepeat: slide in slides -->
                                    <div class="item text-center ng-scope ng-isolate-scope">
                                        <div class="mobile-slider__img ng-scope"
                                            style="background-image: url(/public/woocasino/images/bg/499/original/wolf-bg-mob.jpg)">
                                        </div>
                                    </div>
                                    <!-- end ngRepeat: slide in slides -->
                                    <div class="item text-center ng-scope ng-isolate-scope">
                                        <div class="mobile-slider__img ng-scope"
                                            style="background-image: url(/public/woocasino/images/bg/437/original/trnm-live-mob.jpg)">
                                        </div>
                                    </div>
                                    <!-- end ngRepeat: slide in slides -->
                                    <div class="item text-center ng-scope ng-isolate-scope">
                                        <div class="mobile-slider__img ng-scope"
                                            style="background-image: url(/public/woocasino/images/bg/436/original/3-Mission768-640.jpg)">
                                        </div>
                                    </div>
                                    <!-- end ngRepeat: slide in slides -->
                                    <div class="item text-center ng-scope ng-isolate-scope">
                                        <div class="mobile-slider__img ng-scope"
                                            style="background-image: url(/public/woocasino/images/bg/541/original/woo_drops_770x640-min.jpg)">
                                        </div>
                                    </div>
                                    <!-- end ngRepeat: slide in slides -->
                                </div>
                                    ...
                                    <div>
                                        @if (!isset(auth()->user()->username))
                                            <div class="ng-isolate-scope">
                                                ...
                                                <button
                                                    class="modal-btn button button-primary header-auth__reg-btn ng-scope"
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="item text-center ng-scope ng-isolate-scope active">
                                        <div class="main-slider__img ng-scope"
                                            style="background-image: url(/public/woocasino/images/bg/350/original/vip1310.jpg)">
                                        </div>
                                    </div>
                                    <!-- end ngRepeat: slide in slides -->
                                    <div class="item text-center ng-scope ng-isolate-scope">
                                        <div class="main-slider__img ng-scope"
                                            style="background-image: url(/public/woocasino/images/bg/486/original/WooCasino-slider-WolfGold-1310x380-min.jpg)">
                                        </div>
                                    </div>
                                    <!-- end ngRepeat: slide in slides -->
                                    <div class="item text-center ng-scope ng-isolate-scope">
                                        <div class="main-slider__img ng-scope"
                                            style="background-image: url(/public/woocasino/images/bg/352/original/livedeal1310.jpg)">
                                        </div>
                                    </div>
                                    <!-- end ngRepeat: slide in slides -->
                                    <div class="item text-center ng-scope ng-isolate-scope">
                                        <div class="main-slider__img ng-scope"
                                            style="background-image: url(/public/woocasino/images/bg/351/original/mission1310.jpg)">
                                        </div>
                                    </div>
                                    <!-- end ngRepeat: slide in slides -->
                                    <div class="item text-center ng-scope ng-isolate-scope">
                                        <div class="main-slider__img ng-scope"
                                            style="background-image: url(/public/woocasino/images/bg/540/original/1310x380-min.jpg)">
                                        </div>
                                    </div>
                                    <div class="item text-center ng-scope ng-isolate-scope">
                                        <div class="main-slider__img ng-scope"
                                            style="background-image: url(/public/woocasino/images/bg/435/original/xmas.jpg)">
                                        </div>
                                    </div>
                                    <!-- end ngRepeat: slide in slides -->
                                        ...
                                        <div class="main-slider__promo active">
                                            ...
                                            <div class="main-slider__promo-wrp">
                                                <p class="main-slider__promo-txt">@lang('app.welcome_package')
                                                    ...
                                                    <br> <span class="main-slider__promo-bg"><span class="text-color-blue">+
                                                            200</span> @lang('app.free_spins')</span>
                                                </p>
                                            ...
                                            <div class="main-slider__promo-wrp">
                                                <p class="main-slider__promo-txt">@lang('app.daily') @lang('app.slot_race')
                                                    ...
                                                    <br> <span class="main-slider__promo-bg">
                                                        <span class="text-color-blue">+ 800 </span> @lang('app.free_spin_every_day')!
                                                    </span>
                                                </p>
                                                <div class="main-slider__btn-wrp ng-isolate-scope">
                                                    <!-- ngIf: !$root.data.user.email -->
                                        ...
                                        <div class="main-slider__promo">
                                            ...
                                            <div class="main-slider__promo-wrp">
                                                <p class="main-slider__promo-txt">@lang('app.complete_all_missions')
                                                    <br> <span class="main-slider__promo-separator"><span
                                                            class="text-color-yellow">@lang('app.and') @lang('app.get_more_than')
                                                            <br>$/€150,000 in @lang('app.rewards')</span> </span>
                                                </p>
                                                <div class="main-slider__btn-wrp ng-isolate-scope">
                                                    <!-- ngIf: !$root.data.user.email -->
                                                    <button class="button button-secondary"> @lang('app.play_now') </button>
                                    ...
                                    @for ($i = 0; $i < 5; $i++)
                                        ...
                                        <li class="last-winners__item ng-scope">
                                            <button class="last-winners__img-block">
                                                <img class="last-winners__img"
                                                    src="/public/frontend/Default/ico/{{ $g->name }}.jpg">
                                            ...
                                            <div class="last-winners__info">
                                                <div class="last-winners__info-wrp">
                                                    ...
                                                    <p class="last-winners__game-name"> <span
                                                        ...
                                                        <button
                                                            class="last-winners__game-link">{{ $g->title }}</button>
                                                    </p>
                                                </div>
                                                <p class="last-winners__sum ng-binding">€
                                                    {{ number_format(rand(5, 3000) / rand(1, 10), 2) }}</p>
                                            </div>
                                        </li>
                                    @endfor
                                @endif
                            ...
                            <li class="games-menu__item games-menu__item--new-games">
                                <a class="games-menu__link games-menu__link--new-games"
                                    href="{{ route('frontend.game.list.category', 'new') }}"> <i
                                        ...
                                        class="games-menu__title ng-scope">@lang('app.new_menu')</span> </a>
                            </li>
                            <!-- end ngRepeat: filter_collection in gamesData.data.collections | limitTo: 9 -->
                            <li class="games-menu__item games-menu__item--slots">
                                <a class="games-menu__link games-menu__link--slots"
                                    href="{{ route('frontend.game.list.category', 'slots') }}"> <i
                                        ...
                                        class="games-menu__title ng-scope">@lang('app.slots_menu')</span> </a>
                            </li>
                            <!-- end ngRepeat: filter_collection in gamesData.data.collections | limitTo: 9 -->
                            <li class="games-menu__item games-menu__item--jackpot">
                                <a class="games-menu__link games-menu__link--jackpot"
                                    href="{{ route('frontend.game.list.category', 'jackpots') }}"> <i
                                        class="games-menu-icon games-menu-icon--jackpot"></i> <span
                                        class="games-menu__title ng-scope">@lang('app.jackpots_menu')</span> </a>
                            </li>
                            <li class="games-menu__item games-menu__item--roulette-games">
                                <a class="games-menu__link games-menu__link--roulette-games"
                                    href="{{ route('frontend.game.list.category', 'roulette') }}"> <i
                                        ...
                                        class="games-menu__title ng-scope">@lang('app.roulette_menu')</span> </a>
                            </li>
                            </li>
                            <li class="games-menu__item games-menu__item--bonus_buy_slots">
                                <a class="games-menu__link games-menu__link--bonus_buy_slots" href="javascript:;"
                                    ng-click="openModal($event, '#bonus-modal')"> <i
                                        class="games-menu-icon games-menu-icon--bonus_buy_slots"></i> <span
                                        class="games-menu__title ng-scope">@lang('app.bonuses_menu')</span> </a>
                            </li>
                            <li class="games-menu__item games-menu__item--roulette-games">
                                <a class="games-menu__link games-menu__link--roulette-games"
                                    href="{{ route('frontend.game.list.category', 'instantwins') }}"> <i
                                        class="games-menu-icon games-menu-icon--instant-wins"></i> <span
                                        class="games-menu__title ng-scope">Instant Wins</span> </a>
                            </li>
                            <li class="games-menu__item games-menu__item--roulette-games">
                                <a class="games-menu__link games-menu__link--roulette-games"
                                    href="{{ route('frontend.game.list.category', 'my_games') }}"> <i
                                        class="games-menu-icon games-menu-icon--favorite-games"></i> <span
                                        class="games-menu__title ng-scope">@lang('app.mygames_menu')</span> </a>
                            </li>
                        </ul>
                    </nav>
                </div>
                                ...
                                <li class="providers__item ng-scope">
                                    <a class="providers__link" scroll-up=""
                                        ...
                                        <span class="providers__icon">
                                            <img class="providers__icon-img providers__icon-img--{{ $v }}"
                                                alt="{{ $v }}"
                                                src="/public/woocasino/logos/providers_small/color/{{ $v }}.svg">
                                        </span>
                                ...
                                @if (!in_array($category->href, $top_categories))
                                    <li class="providers__dropdown-item ng-scope">
                                        <a class="providers__link"
                                            ...
                                            <span class="providers__icon">
                                                <img class="providers__icon-img providers__icon-img--1x2gaming"
                                                    alt=""
                                                    src="/public/woocasino/logos/providers_small/color/{{ $category->href }}.svg">
                                            </span>
                    ...
                    <div class="promo-block">
                        ...
                        <div class="toggle-block">
                            <div class="toggle-block__item">
                                <h3 class="toggle-block_header collapsed" data-toggle="collapse"
                                    data-target="#toggle-block-1">
        ...
        <div class="modal" id="bonus-modal" style="width: auto;">
            ...
            <div class="modal__body">
                <iframe src="/public/frontend/Default/img/bitcoin-casinos-bonus.png"
                    style="width: calc(61vw * 0.7); height: 420px;"></iframe>
            </div>
        </div>
    </main>
    <script>
