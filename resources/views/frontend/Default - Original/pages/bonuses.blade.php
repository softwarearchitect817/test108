            ...
            @foreach ($bonuses as $item)
                ...
                @if ($item['is_first'])
                    @if ($item['type'] == 'happyhour')
                        <div class="bonus-page__banner bonus-banner"
                            style="background-image: url('/public/frontend/Default/img/_src/banner-bg.png')">
                        ...
                        <div class="bonus-page__banner bonus-banner"
                            ...
                            <div class="bonus-banner__text">
                                ...
                                <h2 class="bonus-banner__title">
                                    ...
                                    Payment Sum {{ __('app.' . $item['data']->type) }}
                                    {{ $item['data']->sum }}{{ $currency }}
                            ...
                            <div class="bonus-banner__text">
                                ...
                                <h2 class="bonus-banner__title">
                                    ...
                                    @foreach ($item['data'] as $res)
                                        Days {{ $res->days }} {{ $res->bonus }} {{ $currency }}
                                        x{{ $res->wager }} <br>
                                    @endforeach
                                </h2>
                            </div>
                    ...
                    @elseif($item['type'] == 'welcome_bonus')
                        <div class="bonus-page__banner bonus-banner"
                            ...
                            <div class="bonus-banner__text">
                                ...
                                <h2 class="bonus-banner__title">
                                    <span class="accent">Bonus up to {{ $item['data']->bonus }}
                                        {{ $currency }}</span>
                    ...
                    @if (!$item['is_first'])
                        @if ($item['type'] == 'happyhour')
                            <div class="bonus-cards__item">
                                ...
                                <div class="bonus-cards__img">
                                    <img src="/public/frontend/Default/img/_src/WelcomeBonus3.png" alt="">
                                </div>
                                <div class="bonus-cards__info">
                                    <span class="bonus-cards__label">Happy Hour</span>
                                    <p class="bonus-cards__title">
                                        <span class="accent">All deposits will be multiplied by
                                            {{ $item['data']->multiplier }}</span>
                                        Time {{ \VanguardLTE\HappyHour::$values['time'][$item['data']->time] }}
                                    </p>
                                </div>
                            </div>
                        @elseif($item['type'] == 'progress')
                            <div class="bonus-cards__item">
                                ...
                                <div class="bonus-cards__img">
                                    <img src="/public/frontend/Default/img/_src/ProgressBonus.png" alt="">
                                </div>
                                <div class="bonus-cards__info">
                                    <span class="bonus-cards__label">Progress Bonus</span>
                                    <p class="bonus-cards__title">
                                        <span class="accent">Minimal amount of deposit is {{ $item['data']->sum }}
                                            {{ $currency }}</span>
                                        Bonus {{ $item['data']->bonus }} {{ $currency }}
                                    </p>
                                </div>
                        ...
                        @elseif($item['type'] == 'invite')
                            <div class="bonus-cards__item">
                                ...
                                <div class="bonus-cards__img">
                                    <img src="/public/frontend/Default/img/_src/InviteFriends.png" alt="">
                                </div>
                                <div class="bonus-cards__info">
                                    <span class="bonus-cards__label">Invite Friends</span>
                                    <p class="bonus-cards__title">
                                        <span class="accent">For each friend get a bonus {{ $item['data']->sum }}
                                            {{ $currency }}</span>
                        ...
                        @elseif($item['type'] == 'sms_bonus')
                            <div class="bonus-cards__item">
                                ...
                                <div class="bonus-cards__img">
                                    <img src="/public/frontend/Default/img/_src/SMSBonus.png" alt="">
                                </div>
                                <div class="bonus-cards__info">
                        ...
                        @elseif($item['type'] == 'welcome_bonus')
                            <div class="bonus-cards__item">
                                ...
                                <div class="bonus-cards__img">
                                    <img src="/public/frontend/Default/img/_src/WelcomeBonus{{ $item['data']->pay }}.png"
                                        alt="">
                                </div>
                                <div class="bonus-cards__info">
