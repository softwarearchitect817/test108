...
<body class="en" ng-app="app" ng-controller="gameCtrl">
    ...
    <div class="ls__fixed__btn">
        ...
        <a href="https://t.me/goldsvetworkshop"
            style="display: inline-block; padding:16px; border-radius: 8px; background-color: #31a9df; color: #fff; text-decoration: none; font-family: sans-serif; font-size: 16px;">Live
            Dev Support</a><img src="/public/frontend/Default/img/tele.png" /></a>
    </div>
    ...
    <div class="footer">
        <div class="col-1">
            <div class="games__footer__icons">
                <img src="/public/woocasino/images/footer_icons_0.png" />
                <br />
