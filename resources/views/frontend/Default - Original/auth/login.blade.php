            ...
            <div class="login__left">
                <form class="login-form" action="<?= route('frontend.auth.login.post') ?>" id="login-form" method="POST">
                    ...
                    <div class="input__group">
                        <input type="text" id="username" name="username" placeholder="@lang('app.email_or_username')"
                            class="loginInput">
                    </div>
                    <div class="input__group">
                    ...
                    <span style="margin-top: 5px;">Forgot password ? <a href="{{ url('password/remind') }}">Click
                            here</a></span>
                    <br><br>
