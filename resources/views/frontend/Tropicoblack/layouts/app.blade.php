...
<head>
    ...
    <link rel="icon" href="/public/frontend/Tropicoblack/img/favicon.png">

    <link rel="stylesheet" href="/public/frontend/Tropicoblack/css/slick.css">
    <link rel="stylesheet" href="/public/frontend/Tropicoblack/css/styles.min.css">

    <script src="/public/frontend/Tropicoblack/js/jquery-3.4.1.min.js"></script>

    <link rel="stylesheet" type="text/css"
        href="/public/frontend/Tropicoblack/public/assets/vendors/google/css/roboto.css" />
    <link rel="stylesheet" type="text/css"
        href="/public/frontend/Tropicoblack/public/assets/vendors/bootstrap/4.3.1/css/bootstrap.min.css" />
    <link rel="stylesheet" type="text/css"
        href="/public/frontend/Tropicoblack/public/assets/vendors/swiper/4.5.0/css/swiper.min.css" />
    <link rel="stylesheet" type="text/css"
        href="/public/frontend/Tropicoblack/public/assets/vendors/odometer/0.4.6/css/odometer-theme-default.css" />
    <link rel="stylesheet" type="text/css"
        href="/public/frontend/Tropicoblack/public/assets/vendors/bootstrap-select/1.13.9/css/bootstrap-select.min.css" />
    <link rel="stylesheet" type="text/css"
        href="/public/frontend/Tropicoblack/public/assets/vendors/flag-icon-css/3.3.0/css/flag-icon.min.css" />
    <link rel="stylesheet" type="text/css"
        href="/public/frontend/Tropicoblack/public/assets/vendors/flaticon/flaticon.css" />
    <link rel="stylesheet" type="text/css"
        href="/public/frontend/Tropicoblack/public/assets/vendors/fontawesome/5.10.1/css/all.min.css" />


    <link rel="stylesheet" type="text/css" href="/public/frontend/Tropicoblack/css/alertify.min.css" />
    <link rel="stylesheet" type="text/css" href="/public/frontend/Tropicoblack/css/pisoglentis.css" />
    <link rel="stylesheet" type="text/css" href="/public/frontend/Tropicoblack/public/assets/css/main-black.css" />
...
<body data-type="public">
    ...
    <nav id="sidebar" class="">
        ...
        <div class="sidebar-header">
            <h3 class="text-center">
                ...
                <img src="/public/frontend/Tropicoblack/public/assets/images/ui/tropicana88_logo-bg.png" alt="logo"
                    class="sidebar-logo" />
    ...
    <div id="content">
        ...
        <nav class="navbar position-absolute w-100 p-0" id="slide222">
            <div class="row w-100 m-0">
                ...
                <div class="d-none d-md-block col-sm-4 p-0 text-center text-sm-left">
                    <a href="" class="pl-2">
                        <img src="/public/frontend/Tropicoblack/public/assets/images/ui/tropicana88_logo-bg.png"
            ...
            <div class="row w-100" id="jackpots">
                ...
                <div class="col-4 col-lg-2 pb-1 my-auto">
                    <div class="jackpot-container align-middle w-100 m-auto text-right">
                        <img src="/public/frontend/Tropicoblack/public/assets/images/ui/jackpot-icon-1.png"
                ...
                <div class="col-4 col-lg-2 pb-1 my-auto">
                    <div class="jackpot-container align-middle w-100 m-auto text-right">
                        <img src="/public/frontend/Tropicoblack/public/assets/images/ui/jackpot-icon-2.png"
                            alt="jackpot-icon" class="jackpot-icon float-left" />
                ...
                <div class="col-4 col-lg-2 pb-1 my-auto">
                    <div class="jackpot-container align-middle w-100 m-auto text-right">
                        <img src="/public/frontend/Tropicoblack/public/assets/images/ui/jackpot-icon-3.png"
                            alt="jackpot-icon" class="jackpot-icon float-left" />
                                        ...
                                        @if (in_array($category->href, $companies))
                                            <li class="nav-item mr-2 ml-2 box active"
                                                ...
                                                <a href="javascript: void(0);"><img
                                                        ...
                                                        src="/public/frontend/Tropicoblack/img/companies/{{ $category->href }}.png"></a>
                                            </li>
                                        @endif
                                    @endforeach
                                @endif
        ...
        <script>
                ...
                @foreach ($games as $key => $game)
                    {
                        ...
                        "gameName": "{{ $game['title'] }}",
                        "imageUrl": "{{ $game->name ? '/public/frontend/Tropicoblack/ico/' . $game->name . '.jpg' : '' }}",
                        "data-src": "{{ $game->name ? '/public/frontend/Tropicoblack/ico/' . $game->name . '.jpg' : '' }}",
                        "mobileGame": false
                    },
                @endforeach
            ...
            var GLOBAL_BANNERS_LIST = {
                slide1: "/public/frontend/Tropicoblack/public/assets/images/slides/1.jpg",
                slide2: "/public/frontend/Tropicoblack/public/assets/images/slides/2.jpg",
                slide3: "/public/frontend/Tropicoblack/public/assets/images/slides/3b.jpg",
                slide4: "/public/frontend/Tropicoblack/public/assets/images/slides/4.jpg",
                slide5: "/public/frontend/Tropicoblack/public/assets/images/slides/5.jpg",
                slide6: "/public/frontend/Tropicoblack/public/assets/images/slides/6.jpg",
                slide7: "/public/frontend/Tropicoblack/public/assets/images/slides/7.jpg",
                slide8: "/public/frontend/Tropicoblack/public/assets/images/slides/8.jpg",
                slide9: "/public/frontend/Tropicoblack/public/assets/images/slides/9.jpg",
                slide10: "/public/frontend/Tropicoblack/public/assets/images/slides/10.jpg",
                slide11: "/public/frontend/Tropicoblack/public/assets/images/slides/11.jpg"
            };
        ...
        <footer>
            <div class="row m-0">
                <div class="col-12 col-md-3 p-0 border-container">
                    ...
                    <div class="container text-center">
                        <img src="/public/frontend/Tropicoblack/public/assets/images/ui/devices.png" alt=""
                            class="w-50 mb-1" />
                        <br />
                ...
                <div class="col-12 col-md-3 p-0 border-container">
                    ...
                    <div class="container text-center">
                        <img src="/public/frontend/Tropicoblack/public/assets/images/ui/secure_website.png"
                            alt="" class="w-50 mb-1" />
                        <p class="text-justify">
                    ...
                    <div class="container">
                        <div class="row m-0">
                            <div class="col-6 col-md-12 p-0 text-center">
                                <a href="#">
                                    <img src="/public/frontend/Tropicoblack/public/assets/images/vendors/shadow/q1x2gaming.png"
                                        alt="q1x2gaming" style="max-width: 100px;" />
                                </a>
                            </div>
                            <div class="col-6 col-md-12 p-0 text-center">
                                <a href="#">
                                    <img src="/public/frontend/Tropicoblack/public/assets/images/vendors/shadow/amatic.png"
                                        alt="amatic" style="max-width: 100px;" />
                                </a>
                            </div>
                            <div class="col-6 col-md-12 p-0 text-center">
                                <a href="#">
                                    <img src="/public/frontend/Tropicoblack/public/assets/images/vendors/shadow/bomba.png"
                                        alt="bomba" style="max-width: 100px;" />
                                </a>
                            </div>
                            <div class="col-6 col-md-12 p-0 text-center">
                                <a href="#">
                                    <img src="/public/frontend/Tropicoblack/public/assets/images/vendors/shadow/egt.png"
                                        alt="egt" style="max-width: 100px;" />
                                </a>
                            </div>
                            <div class="col-6 col-md-12 p-0 text-center">
                                <a href="#">
                                    <img src="/public/frontend/Tropicoblack/public/assets/images/vendors/shadow/netent.png"
                                        alt="netent" style="max-width: 100px;" />
                                </a>
                            </div>
                            <div class="col-6 col-md-12 p-0 text-center">
                                <a href="#">
                                    <img src="/public/frontend/Tropicoblack/public/assets/images/vendors/shadow/novomatic.png"
                                        alt="novomatic" style="max-width: 100px;" />
                                </a>
                            </div>
                            <div class="col-6 col-md-12 p-0 text-center">
                                <a href="#">
                                    <img src="/public/frontend/Tropicoblack/public/assets/images/vendors/shadow/spin2win.png"
                                        alt="spin2win" style="max-width: 100px;" />
                                </a>
                            </div>
                            <div class="col-6 col-md-12 p-0 text-center">
                                <a href="#">
                                    <img src="/public/frontend/Tropicoblack/public/assets/images/vendors/shadow/wazdan.png"
                ...
                <div class="col-12 col-md-2 p-0 border-container">
                    ...
                    <div class="row m-0">
                        <div class="col-6 p-0 text-center">
                            <a href="#">
                                <img src="/public/frontend/Tropicoblack/public/assets/images/ui/facebook.png"
                                    alt="facebook" class="p-2" style="max-width: 64px;" />
                            </a>
                        </div>
                        <div class="col-6 p-0 text-center">
                            <a href="#">
                                <img src="/public/frontend/Tropicoblack/public/assets/images/ui/twitter.png"
                                    alt="twitter" class="p-2" style="max-width: 64px;" />
                            </a>
                        </div>
                        <div class="col-6 p-0 text-center">
                            <a href="#">
                                <img src="/public/frontend/Tropicoblack/public/assets/images/ui/youtube.png"
                                    alt="youtube" class="p-2" style="max-width: 64px;" />
                            </a>
                        </div>
                        <div class="col-6 p-0 text-center">
                            <a href="#">
                                <img src="/public/frontend/Tropicoblack/public/assets/images/ui/instagram.png"
                                    alt="instagram" class="p-2" style="max-width: 64px;" />
                            </a>
                        </div>
                        <div class="col-6 p-0 text-center">
                            <a href="#">
                                <img src="/public/frontend/Tropicoblack/public/assets/images/ui/linkedin.png"
                                    alt="linkedin" class="p-2" style="max-width: 64px;" />
                            </a>
                        </div>
                        <div class="col-6 p-0 text-center">
                            <a href="#">
                                <img src="/public/frontend/Tropicoblack/public/assets/images/ui/pinterest.png"
                                    alt="pinterest" class="p-2" style="max-width: 64px;" />
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-2 p-0 border-container">
                    ...
                    <div class="container text-center">
                        <h6>24/7 Support</h6>
                        <img src="/public/frontend/Tropicoblack/public/assets/images/ui/18plus.png" alt=""
                            class="mb-1" style="max-width: 64px;" />
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-3">
                    <div class="w-100 text-center mb-4">
                        <img src="/public/frontend/Tropicoblack/img/ticket_logo.png" alt="logo" />
                    </div>
    ...
    <div class="modal fade " id="bonus3-modal" tabindex="-1" role="dialog" aria-labelledby="ticket-modal-title"
        ...
        <script src="/public/frontend/Tropicoblack/public/assets/vendors/jquery/3.4.1/jquery-3.4.1.min.js"></script>
        <script src="/public/frontend/Tropicoblack/js/jquery-ui.js"></script>
        <script src="/public/frontend/Tropicoblack/public/assets/vendors/popper/1.14.7/popper.min.js"></script>
        <script src="/public/frontend/Tropicoblack/public/assets/vendors/bootstrap/4.3.1/js/bootstrap.min.js"></script>
        <script src="/public/frontend/Tropicoblack/public/assets/vendors/swiper/4.5.0/js/swiper.min.js"></script>
        <script src="/public/frontend/Tropicoblack/public/assets/vendors/odometer/0.4.6/js/odometer.min.js"></script>
        <script src="/public/frontend/Tropicoblack/public/assets/vendors/bootstrap-select/1.13.9/js/bootstrap-select.min.js">
        </script>
        <script src="/public/frontend/Tropicoblack/js/alertify.min.js?v=8324"></script>
        <script src="/public/frontend/Tropicoblack/js/bonus.min.js?v=8324"></script>
        <script src="/public/frontend/Tropicoblack/public/assets/js/games.js"></script>
        <script src="/public/frontend/Tropicoblack/public/assets/js/tools.js"></script>
        <script src="/public/frontend/Tropicoblack/public/assets/js/main.js"></script>
        <script src="/public/frontend/Tropicoblack/public/assets/js/ui.js"></script>
