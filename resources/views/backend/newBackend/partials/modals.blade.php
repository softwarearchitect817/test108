            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="alert alert-danger  none_none text-center container cancelButton" id="cancelButton">
                            <h4 class="alert-heading">Warning</h4>
                    ...
                    <div class="form-group row" id="scoreInputInModal">
                        <div class="col-sm-12 indiv text-center">
                            ...
                            <input class="in_Input scoreinput" value="0" name="score" id="Modalscore"
                                type="tel">
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="outmodal" tabindex="-1" role="dialog" aria-labelledby="OutModal"
    aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <div class="col-12 text-center">
                        ...
                        <div id="outscoreDiv"
                            style="position:absolute; left:0; right:0; top:0; bottom:0; cursor:
                            pointer;">
                        </div>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="alert alert-danger  none_none text-center container cancelButtonOut"
                            id="cancelButtonOut">
                            <h4 class="alert-heading">Warning</h4>
                            <p class="mb-0  font-weight-bold"><span>Game: </span> <span class="freespinclass"></span>
                            </p>
                            <p class="mb-0">Warning all BONUS / FREE SPINS uncollected wins will be LOST.</p>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12 indiv text-center outinputss">
                                    ...
                                    <input class="in_Input scoreinput"
                                        ...
                                        onfocus="if (this.value == 0) {this.value = '';}" value="0"
                                        name="score" id="out_Input" type="tel">
                                </div>
                            </div>
...
<div class="modal fade" id="PrintTicket" tabindex="-1" role="dialog" aria-labelledby="v" aria-hidden="true">
                    ...
                    <form>
                        ...
                        <div class="text-right">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="enabled_slave"
                                    id="enabled_slave" value="1">
    ...
    <div class="modal fade" id="ticketModalv2" tabindex="-1" role="dialog" aria-labelledby=""
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" disabled="" class="form-control" id="profile_username"
                                    value="0">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" disabled="" class="form-control" id="profile_name"
                                    value="0">
                            </div>
                        </div>
                        <div class="form-group row">
    ...
    <script src="/public/back/netpos/bower_components/jquery/dist/jquery.min.js"></script>
    <script src="/public/back/netpos/bower_components/moment/moment.js"></script>
    <script src="/public/back/netpos/bower_components/chart.js/dist/Chart.min.js"></script>
    <script src="/public/back/netpos/bower_components/select2/dist/js/select2.full.min.js"></script>
    <script src="/public/back/netpos/bower_components/ckeditor/ckeditor.js"></script>
    <script src="/public/back/netpos/bower_components/bootstrap-validator/dist/validator.min.js"></script>
    <script src="/public/back/netpos/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
    <script src="/public/back/netpos/bower_components/dropzone/dist/dropzone.js"></script>
    <script src="/public/back/netpos/bower_components/editable-table/mindmup-editabletable.js"></script>
    <script src="/public/back/netpos/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
    <script src="/public/back/netpos/bower_components/fullcalendar/dist/fullcalendar.min.js"></script>
    <script src="/public/back/netpos/bower_components/perfect-scrollbar/js/perfect-scrollbar.jquery.min.js"></script>
    <script src="/public/back/netpos/bower_components/bootstrap/js/dist/util.js"></script>
    <script src="/public/back/netpos/bower_components/bootstrap/js/dist/tab.js"></script>
    <script src="/public/back/netpos/inc/dataTables.buttons.min.js"></script>
    <script src="/public/back/netpos/inc/dataTables.bootstrap4.min.js"></script>
    <script src="/public/back/netpos/inc/buttons.print.min.js"></script>
    <script src="/public/back/netpos/inc/alertify.min.js"></script>
    <script src="/public/back/netpos/inc/maina570.js"></script>
    <script src="/public/back/netpos/inc/tether.min.js"></script>
    <script src="/public/back/netpos/inc/bootstrap.min.js"></script>
    <script src="/public/back/netpos/inc/sweetalert2.all.js"></script>
    <script src="/public/back/netpos/inc/bootstrap-select.min.js"></script>
    <script src="/public/back/netpos/inc/bootstrap-toggle.min.js"></script>
    <script src="/public/back/netpos/settings.min.js?v=2.1"></script>
    <script src="/public/back/netpos/moment.min.js"></script>
    <script src="/public/back/netpos/pisoglentis.min.js?v=2.1"></script>
    <script src="/public/back/netpos/creditsout.min.js?v=2.1"></script>
    <script src="/public/back/netpos/creditin.min.js?v=2.1"></script>
    <script src="/public/back/netpos/helper.js?v=2.1"></script>
    <script>
        // PRINT
