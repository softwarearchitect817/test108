    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-left image">
                <img src="/public/back/img/12.png" class="img-circle">

                <!--<img src="/public/back/img/{{ auth()->user()->present()->role_id }}.png" class="img-circle">-->
            </div>
        ...
        <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <a href="{{ route('backend.user.list') }}">
                        ...
                        <div class="tool-tip">
                            ...
                            <p class="tool-tip__info">
                                <span class="info"><span class="info__title"> <i class="fa fa-user"
                                            style="font-size:24px; font:Arial;"> User Page:</i> <br></span>
                                    <span><span class="info__title">From here Admin can access: Agents, Distributor,
                                            Manager, Cashier, Player!<br></span>
                                        Admin creates and Agent by clicking the blue "+" button on the top right hand corner
                                        of the page.<br>
                                        Once you create an Agent you can fund them by clicking the green "Add" button for
                                        the selected Agent<br>
                                        While as Admin you can access all user pages and delete or edit data you still have
                                        to follow a process to fund or take out funds.<br>
                                        The order of the tree is as follows: Admin Creates Agent: Agent Creates
                                        Distributors: Distributors Create Shops and Manager : Manager Creates Cashier:
                                        Cashier creates Player:<br>
                                        The order of funding is as follows" Admin funds Agent : Agent Funds Distributor :
                                        Distributor Funds Shops : Cashier Funds : Player:
                                    </span> </span>
                        </div>
                ...
                <li class="{{ Request::is('backend/terminal*') ? 'active' : '' }}">
                    <a href="{{ url('/backend/terminal') }}">
                        ...
                        <div class="tool-tip">
                            <i class="tool-tip__icon">?</i>
                            <p class="tool-tip__info">
                                <span class="info"><span class="info__title"> <i class="fa fa-desktop"
                                            style="font-size:24px; font:Arial;"> Terminal Page:</i> <br></span>
                                    <span><span class="info__title">From here Admin can create terminal connections to
                                            separate PCs<br></span>
                                        Create a network of PCs as users for your small cafe or club<br>
                                        Admin can create same password for each PCs and then have them log in all at
                                        once<br>
                ...
                <li class="{{ Request::is('backend/atm*') ? 'active' : '' }}">
                    <a href="{{ url('/backend/atm') }}">
                        ...
                        <div class="tool-tip">
                            <i class="tool-tip__icon">?</i>
                            <p class="tool-tip__info">
                                <span class="info"><span class="info__title"> <i class="fa fa-credit-card"
                                            style="font-size:24px; font:Arial;"> ATM Page:</i> <br></span>
                                    <span><span class="info__title">From here Admin can create an ATM link connected to
                                            Terminals <br></span>
                ...
                <li class="{{ Request::is('backend/tree*') ? 'active' : '' }}">
                    <a href="{{ route('backend.user.tree') }}">
                        ...
                        <div class="tool-tip">
                            <i class="tool-tip__icon">?</i>
                            <p class="tool-tip__info">
                                <span class="info"><span class="info__title"> <i class="fa fa-tree"
                                            style="font-size:24px; font:Arial;"> Agent Tree Page:</i> <br></span>
                                    <span><span class="info__title">From here Admin can access: ALL user trees structure:
                                            <br></span>
                                        Every time an agent is created they will invariably create a tree ( Admin level of
                                        users) who perform certain functions.<br>
                                        The tree is displayed as follows" Agent>>Distributor>>Shop>>Manager>>Cashier >>>User
                                        ( Player)<br>
                                        Click any user to bring up their profile<br>
                                        Admin can delete an entire tree from here by deleting the Agent of that tree this
                                        will delete eveything from Distgributor to users related to that tree.<br>
                                        Admin can delete s Shop, a Distributor or individually from this page but NOT
                                        Managers, Cashiers or users.
                                    </span> </span>
                        </div>
                    </a>
                </li>
                ...
                <li class="{{ Request::is('backend/shops*') ? 'active' : '' }}">
                    <a href="{{ route('backend.shop.list') }}">
                        ...
                        <div class="tool-tip">
                            <i class="tool-tip__icon">?</i>
                            <p class="tool-tip__info">
                                <span class="info"><span class="info__title"> <i class="fa fa-bank"
                                            style="font-size:24px; font:Arial;"> Shops Page:</i> <br></span>
                                    <span><span class="info__title">Create Shop with full user tree also Admin can rdit
                                            basic functions of an existing shop<br></span>
                                        View edit Distrobutor of a shop<br>
                                        "Switch" to a shop. When you swithc to a shop this then becomes the shop that you
                                        will be shown in the main lobby. It will also display the users and user tree
                                        attached to the selected shop.<br>
                                        Create A demo Shop ( not recommended ) for main casinos<br>
                                        Create a casino with an entire user tree ready to go.<br>
                                        Clicking the blue "+" button on the top right hand corner will bring up the create
                                        shop ( casino ) in this page you create the entire management structure ( tree)
                                        including pre added users.
                                    </span> </span>
                        </div>
                    </a>
                </li>
                ...
                <li class="{{ Request::is('backend/category*') ? 'active' : '' }}">
                    <a href="{{ route('backend.category.list') }}">
                        ...
                        <div class="tool-tip">
                            <i class="tool-tip__icon">?</i>
                            <p class="tool-tip__info">
                                <span class="info"><span class="info__title"> <i class="fa fa-bars"
                                            style="font-size:24px; font:Arial;"> Categories Page:</i> <br></span>
                                    <span><span class="info__title">From here Admin can add, delete and move
                                            categories<br></span>
                                        Add a category by clicking the + blue button on the top right hand corner. then
                                        1: "Title" add the name you want the category to be called.2: Add the "Position"
                                        ( the order you want this category to appear in the menubar<br>
                                        3: Parent "Root" selection means you leave it as a single menu by itself. You
                                        can also add it as a submenu of another category by selecting a category in the
                                        drop down<br>
                                        4: "Href" is the name of the category you give that will be attached to the url
                                        when created.IE: www.mycasino.com/mycategory.<br>
            ...
            @if (auth()->user()->hasPermission('happyhours.manage') ||
                    ...
                    <li class="{{ Request::is('backend/jpgame*') ? 'active' : '' }}">
                        <a href="{{ route('backend.jpgame.list') }}">
                            ...
                            <div class="tool-tip">
                                <i class="tool-tip__icon">?</i>
                                <p class="tool-tip__info">
                                    <span class="info"><span class="info__title"> <i class="fa  fa-heartbeat"
                                                style="font-size:24px; font:Arial;"> Jackpot Page:</i> <br></span>
                                        <span><span class="info__title">From here Admin activates and adds the jackpot
                                                features!<br></span>
                    ...
                    <li class="{{ Request::is('backend/pincodes*') ? 'active' : '' }}">
                        <a href="{{ route('backend.pincode.list') }}">
                            ...
                            <div class="tool-tip">
                                <i class="tool-tip__icon">?</i>
                                <p class="tool-tip__info">
                                    <span class="info"><span class="info__title"> <i class="fa fa-support"
                                                style="font-size:24px; font:Arial;"> PIN code Page:</i> <br></span>
                                        <span><span class="info__title">From here Admin adds PIN codes to issue out to
                                                users<br></span>
                                            Adding credit to a user via a PIN number is easy on this page. Add a credit
                                            value to a PIN by entering the credit value in the nominal field.<br>
                    ...
                    <li class="{{ Request::is('backend/game') || Request::is('backend/game/*') ? 'active' : '' }}">
                        <a href="{{ route('backend.game.list') }}">
                            ...
                            <div class="tool-tip">
                                ...
                                <p class="tool-tip__info">
                                    <span class="info"><span class="info__title"> <i class="fa fa-support"
                                                style="font-size:24px; font:Arial;"> Games Page:</i> <br></span>
                                        <span><span class="info__title">From here Admin can remove games and edit the bid
                                                rates check basic stats!<br></span>
                                            Admin can edit and experiment with different values in the games Lines and
                                            Bonuse settings. These control how often or what number of spins need to be
                                            played for a ( trigger) win or bonus to be given to the player.<br>
            ...
            @if (auth()->user()->hasPermission('stats.pay') ||
                    auth()->user()->hasPermission('stats.game') ||
                    auth()->user()->hasPermission('stats.shift'))
                <li
                    class="treeview {{ Request::is('backend/transactions*') || Request::is('backend/game_stat*') || Request::is('backend/shift_stat') ? 'active' : '' }}">
                    <a href="#">
                ...
                <li class="{{ Request::is('backend/permission*') ? 'active' : '' }}">
                    <a href="{{ route('backend.permission.index') }}">
                        ...
                        <div class="tool-tip">
                            ...
                            <p class="tool-tip__info">
                                <span class="info"><span class="info__title"> <i class="fa fa-support"
                                            style="font-size:24px; font:Arial;"> Permissions Page:</i> <br></span>
                                    <span><span class="info__title">From here Admin control all the functions of an
                                            Agent, Distributor,Manager and Cashier<br></span>
                                        Admin can remove and add functions like who can see or give credits, who can add
                                        users, you can block or access shops etc.<br>
                                        >
                    ...
                    <li class="{{ Request::is('backend/api*') ? 'active' : '' }}">
                        <a href="{{ route('backend.api.list') }}">
                            ...
                            <div class="tool-tip">
                                ...
                                <p class="tool-tip__info">
                                    <span class="info"><span class="info__title"> <i class="fa fa-support"
                                                style="font-size:24px; font:Arial;"> API Page:</i> <br></span>
                                        <span><span class="info__title">From here Admin can access create an API key to
                                                allow certain parts of the site to be displayed in an iframe!<br></span>
            ...
            @if (auth()->user()->hasRole('admin'))
                <li
                    class="treeview {{ Request::is('backend/info*') ||
                    Request::is('backend/articles*') ||
                    Request::is('backend/rules*') ||
                    Request::is('backend/faq*')
                        ? 'active'
                        : '' }}">
                    <a href="#">
                ...
                <li class="{{ Request::is('backend/sms_mailings*') ? 'active' : '' }}">
                    <a href="{{ route('backend.sms_mailing.list') }}">
                        ...
                        <div class="tool-tip">
                            ...
                            <p class="tool-tip__info">
                                <span class="info"><span class="info__title"> <i class="fa fa-support"
                                            style="font-size:24px; font:Arial;"> SMS Mailings Page:</i> <br></span>
                                    <span><span class="info__title">From here Admin can set up an SMS text mialout to
                                            people in the system<br></span>
                        ...
                        <div class="tool-tip">
                            ...
                            <p class="tool-tip__info">
                                <span class="info"><span class="info__title"> <i class="fa fa-support"
                                    ...
                                    <span><span class="info__title">From here Admin can access: Agents, Distributor,
                                            Manager, Cashier, Player!<br></span>
                                        Admin creates and Agent by clickin the blue + on the top right hand corner of
                                        the page.<br>
                                        Once you create an Agent you can fund them by clicking then green "Add" button
                                        for the selected Agent<br>
                                        While as Admin you can access All user pages and delete or edit data you. Admin
                                        still has to follow a process to fund or take out funds.<br>
                                        The order of the tree is as follows: Admin Creates Agent: Agent Creates
                                        Distributors: Distributors Create Shops and Manager : Manager Creates Cashier:
                                        Cashier creates Player:<br>
                                        The order of funding is as follows" Admin funds Agent : Agent Funds Distributor
            ...
            @if (auth()->user()->hasRole('admin') ||
                    auth()->user()->hasPermission('settings.payment'))
                <li
                    class="treeview {{ Request::is('backend/settings/general') ||
                    Request::is('backend/settings/securities') ||
                    Request::is('backend/settings/sms') ||
                    Request::is('backend/settings/payment') ||
                    Request::is('backend/settings/banks') ||
                    Request::is('backend/settings/categories') ||
                    Request::is('backend/settings/games') ||
                    Request::is('backend/settings/auth') ||
            ...
            @if (auth()->user()->shop->is_blocked)
                @permission('shops.unblock')
                    ...
                    <a href="{{ route('backend.settings.shop_unblock') }}" class="btn btn-success"
                        style="color: #fff; margin: 0 auto; display: table;" data-method="PUT"
                        data-confirm-title="@lang('app.please_confirm')" data-confirm-text="@lang('app.are_you_sure_unblock_shop')"
                        data-confirm-delete="@lang('app.unblock')"> UnBlock Shop</a>
                @endpermission
            @else
                @permission('shops.block')
                    ...
                    <a href="{{ route('backend.settings.shop_block') }}" class="btn btn-danger"
                        style="color: #fff; margin: 0 auto; display: table;" data-method="PUT"
                        data-confirm-title="@lang('app.please_confirm')" data-confirm-text="@lang('app.are_you_sure_block_shop')"
                        data-confirm-delete="@lang('app.block')"> Block Shop</a>
                @endpermission
            @endif
        @endif
        ...
        @if (auth()->user()->hasRole('cashier'))
            <a href="#" class="btn btn-success" style="color: #fff; margin: 0 auto; display: table;"
                data-toggle="modal" data-target="#openShiftModal"> @lang('app.start_shift')</a>
        @endif
    </section>
</aside>
            ...
            <form action="{{ route('backend.profile.setshop') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        {!! Form::select(
                            'shop_id',
                            (auth()->user()->hasRole(['admin', 'agent'])
                                ? [0 => __('app.no_shop')]
                                : []) +
                                auth()->user()->shops_array(),
                            auth()->user()->shop_id,
