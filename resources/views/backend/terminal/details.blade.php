                    ...
                    <tr>
                        <td>
                            <div>
                                ...
                                <!--<p class="usrimg"><img src="/public/back/img/novostarSL2.png" alt=""></p>-->
                                <p class="usrimg"><img src="/public/back/img/10.png" alt=""></p>
                                    ...
                                    <td>
                                        <select name="status" class="form-control w250">
                                            @foreach ($response['statuses'] as $status)
                                                <option value="{{ $status }}"
                                                    <?= $response['terminal']->status == $status ? 'selected' : '' ?>>
                                                    {{ $status }}
                                                </option>
                                            @endforeach
                                        </select>
