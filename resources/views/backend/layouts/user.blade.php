...
<head>
    ...
    <link rel="stylesheet" href="/public/back/dist/css/skins/_all-skins.min.css">

    <link rel="stylesheet" href="/public/back/bower_components/morris.js/morris.css">
    <link rel="stylesheet" href="/public/back/bower_components/jvectormap/jquery-jvectormap.css">
    <link rel="stylesheet"
        href="/public/back/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
    <link rel="stylesheet"
        href="/public/back/bower_components/bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css">
    <link rel="stylesheet" href="/public/back/bower_components/bootstrap-daterangepicker/daterangepicker.css">

    <link rel="stylesheet" href="/public/back/bower_components/bootstrap-daterangepicker/daterangepicker.css">
    <link rel="stylesheet" href="/public/back/bower_components/bootstrap-tagsinput/bootstrap-tagsinput.css">
    <link rel="stylesheet" href="/public/back/bower_components/croppie/croppie.css">
    <link rel="stylesheet" href="/public/back/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
    <link rel="stylesheet" href="/public/back/bower_components/select2/dist/css/select2.css">
    <link rel="stylesheet" href="/public/back/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">

    <!-- iCheck for checkboxes and radio inputs -->
    <link rel="stylesheet" href="/public/back/plugins/iCheck/all.css">

    <!-- <link rel="stylesheet" href="/public/back/dist/css/new.css"> -->
...
<body class="grey lighten-3">
            ...
            <div class="desktop-menu collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    @permission('users.tree')
                        <li class="nav-item {{ Request::is('backend/tree*') ? 'active' : '' }}">
                            <a href="{{ route('backend.user.tree') }}" class="nav-link waves-effect">
                                ...
                                <span
                                    class="text-uppercase">{{ \VanguardLTE\Role::where('id', auth()->user()->role_id - 1)->first()->name }}
                                    @lang('app.tree')</span>
                            </a>
                        </li>
                    @endpermission
                    ...
                    @permission('games.manage')
                        @if (!(auth()->check() && auth()->user()->shop_id == 0 && auth()->user()->role_id < 6))
                            <li
                                class="nav-item  {{ Request::is('backend/game') || Request::is('backend/game/*') ? 'active' : '' }}">
                    ...
                    @if (Auth::user()->hasPermission('stats.live') ||
                        ...
                        <li
                            class="has-sub-menu {{ Request::is('backend/live*') || Request::is('backend/statistics*') || Request::is('backend/game_stat*') || Request::is('backend/shop_stat') || Request::is('backend/shift_stat') || Request::is('backend/bank_stat') ? 'active' : '' }}">
                            <a href="#menu1sub1sub1" class="list-group-item list-head" data-toggle="collapse"
                                aria-expanded="false">
                                <div class="icon-w">
                            ...
                            <div class="menu-down collapse" id="menu1sub1sub1">
                                ...
                                @permission('stats.live')
                                    <a href="{{ route('backend.live_stat') }}" class="list-group-item"
                                ...
                                @permission('stats.pay')
                                    <a href="{{ route('backend.transactions') }}" class="list-group-item"
                                        data-parent="#menu1sub1sub1">
                                        @lang('app.statistics')
                                    </a>
                                @endpermission
                                ...
                                @permission('stats.game')
                                    <a href="{{ route('backend.game_stat') }}" class="list-group-item"
                                        data-parent="#menu1sub1sub1">
                                        @lang('app.game_stats')
                                    </a>
                                @endpermission
                                ...
                                @permission('stats.bank')
                                    <a href="{{ route('backend.bank_stat') }}" class="list-group-item"
                                        data-parent="#menu1sub1sub1">
                                        @lang('app.bank_stats')
                                    </a>
                                @endpermission
                                ...
                                @permission('stats.shop')
                                    <a href="{{ route('backend.shop_stat') }}" class="list-group-item"
                                        data-parent="#menu1sub1sub1">
                                        @lang('app.shop_stats')
                                    </a>
                                @endpermission
                                ...
                                @permission('stats.shift')
                                    <a href="{{ route('backend.shift_stat') }}" class="list-group-item"
                                        data-parent="#menu1sub1sub1">
                    ...
                    <li class="nav-item {{ Request::is('backend/user/*/profile') ? 'active' : '' }}">
                        <a href="{{ route('backend.user.edit',auth()->user()->present()->id) }}"
            ...
            <div class="container-fluid">
                <ul class="breadcrumb" style="margin-bottom: 0px;">
                    <li class="breadcrumb-item"><a
                            href="{{ route(auth()->user()->hasRole('distributor')? 'backend.dashboard': 'backend.user.list') }}"
                            data-original-title="" title="">Home</a>
                    </li>
                    <li class="breadcrumb-item"><a
                            href="{{ route(auth()->user()->hasRole('distributor')? 'backend.dashboard': 'backend.user.list') }}"
                            data-original-title="" title="">Refresh</a></li>
                    <div class="arrowcss hidden-sm-down">
                        <span style="float: right; font-size: 20px; margin-top: -15px; padding-top: 9px;"
                            class="hidden-xs-down ">
                            <a href="#" id="right_arrow" class="none_none btn2" data-original-title=""
                                title="" style="display: inline;">
                                <i class="os-icon os-icon-arrow-right2"></i>
                            </a>
                            <a href="#" id="left_arrow" class="none_none btn2" data-original-title=""
                ...
                <form action="{{ route('backend.profile.setshop') }}" method="POST">
                    <div class="modal-body">
                        <div class="form-group">
                            {!! Form::select(
                                'shop_id',
                                (Auth::user()->hasRole(['admin', 'agent']) ? [0 => __('app.no_shop')] : []) + Auth::user()->shops_array(),
                                Auth::user()->shop_id,
    ...
    <script src="/public/back/bower_components/jquery-ui/jquery-ui.min.js"></script>
    <script>
        var timezon = '{{ date_default_timezone_get() }}';
        $.widget.bridge('uibutton', $.ui.button);
    </script>
    <script src="/public/back/bower_components/raphael/raphael.min.js"></script>
    <script src="/public/back/bower_components/morris.js/morris.min.js"></script>
    <script src="/public/back/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
    <script src="/public/back/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="/public/back/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <script src="/public/back/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
    <script src="/public/back/bower_components/moment/min/moment.min.js"></script>
    <script src="/public/back/bower_components/moment/min/moment-timezone-with-data-1970-2030.min.js"></script>

    <script src="/public/back/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
    <script src="/public/back/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
    <script src="/public/back/bower_components/bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js"></script>
    <script src="/public/back/bower_components/bootstrap-tagsinput/bootstrap-tagsinput.min.js"></script>
    <script src="/public/back/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
    <script src="/public/back/dist/js/adminlte.js"></script>
    <!-- SweetAlert -->
    <link href="/public/back/bower_components/sweetalert2/bootstrap-4.css" rel="stylesheet">
    <!-- <link rel="stylesheet" href="/public/back/dist/css/additional.css"> -->
    <script src="/public/back/bower_components/sweetalert2/sweetalert2.js"></script>
    <script src="/public/back/bower_components/jquery-slimscroll/jquery.slimscroll.min.js"></script>
    <script src="/public/back/bower_components/fastclick/lib/fastclick.js"></script>
    <script src="/public/back/bower_components/croppie/croppie.js"></script>
    <script src="/public/back/bower_components/select2/dist/js/select2.js"></script>

    <script src="/public/back/js/delete.handler.js"></script>
    <script src="/public/back/bower_components/jquery-validation/jquery.validate.min.js"></script>
    <script src="/public/back/bower_components/jquery-validation/additional-methods.min.js"></script>

    <script src="/public/back/plugins/jquery-cookie/jquery.cookie.min.js"></script>
    <!-- DataTables -->
    <script src="/public/back/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
    <script src="/public/back/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>

    <!-- iCheck 1.0.1 -->
    <script src="/public/back/plugins/iCheck/icheck.min.js"></script>

    <!-- InputMask -->
    <script src="/public/back/plugins/input-mask/jquery.inputmask.js"></script>
    <script src="/public/back/plugins/input-mask/jquery.inputmask.date.extensions.js"></script>
    <script src="/public/back/plugins/input-mask/jquery.inputmask.extensions.js"></script>
