                    ...
                    <div class="box-body box-profile">
                        <center>
                            <img class="img-responsive"
                                src="{{ $edit ? '/public/frontend/Default/ico/' . $game->name . '.jpg' : '' }}"
                                alt="{{ $edit ? $game->name : '' }}">
                        </center>
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item">
                                <b>@lang('app.percent')</b> <a
                                    class="pull-right">{{ $game->shop ? $game->shop->get_percent_label($game->shop->percent) : '0' }}</a>
                            </li>
                            <li class="list-group-item">
                            ...
                            <li class="list-group-item">
                                <b>@lang('app.rtp')</b> <a
                                    class="pull-right">{{ $game->stat_in > 0 ? number_format(($game->stat_out / $game->stat_in) * 100, 2, '.', '') : '0.00' }}</a>
                            </li>
                        </ul>
                        ...
                        <a href="{{ route('backend.game.delete', $game->id) }}" class="btn btn-danger btn-block"
                            ...
                            data-confirm-text="@lang('app.are_you_sure_delete_game')" data-confirm-delete="@lang('app.yes_delete_him')">
                            <b>DELETE</b></a>
                    </div>
                </div>
                    ...
                    <div class="box-body">
                        ...
                        <table class="table table-borderless table-striped">
                            ...
                            <tbody>
                                ...
                                @if (count($game_stat))
                                    @foreach ($game_stat as $stat)
                                        <tr>
                                            <td>
                                                <a
                                                    href="{{ route('backend.game_stat', ['user' => $stat->user->username]) }}">
                                                    {{ $stat->user->username }}
                                                </a>
                                            </td>
                                            <td>{{ $stat->win }}</td>
                                ...
                                @else
                                    <tr>
                                        <td colspan="2">@lang('app.no_data')</td>
                                    </tr>
                                @endif
            ...
            <div class="col-md-9" id="colrighttemp">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a id="bonus-tab" data-toggle="tab" href="#bonus-details">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane" id="login-details">
                            {!! Form::open([
                                'route' => ['backend.game.update', $game->id],
                                'method' => 'POST',
